...
if __name__ == '__main__':
    ...
    # 假设的输入特征尺寸
    # e - 例如图像特征张量[batch_size, channels, height, width]
    # r - 例如文本特征张量[batch_size, channels, height, width]
    e = torch.randn(1, 64, 64, 64)  # 例如来自小尺度特征的图像
    # e = torch.randn(1, 128, 128, 128)  # 例如来自小尺度特征的图像
    r = torch.randn(1, 64, 64, 64)  # 例如来自大尺度特征的图像
    # r = torch.randn(1, 128, 128, 128)  # 例如来自大尺度特征的图像
    ...
    # 打印输入和输出的形状
    print("Shape of input e:", e.shape)
    print("Shape of input r:", r.shape)
