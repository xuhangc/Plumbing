...
class ConvMlp(nn.Module):
    ...
    代码来源：timm：https://github.com/huggingface/pytorch-image-models/blob/v0.6.11/timm/models/layers/mlp.py
    """
    def __init__(
...
if __name__ == '__main__':
    ...
    # 实例化 RCM 模块
    rcm = RCM(dim=num_channels)

    # 打印输入的形状
    print(f"Input shape: {input_tensor.shape}")

    # 将输入张量传递给 RCM 模块，并打印输出形状
    output_tensor = rcm(input_tensor)
