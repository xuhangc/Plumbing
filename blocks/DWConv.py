...
if __name__ == '__main__':
    ...
    input_tensor = torch.randn(1, 3, 32, 32, 32)  # (batch_size, in_channels, height, width)

    # 创建 SeparableConv3d 实例
    separable_conv = SeparableConv3d(in_channels=3, out_channels=3, kernel_size=3, padding=1)
