...
if __name__ == "__main__":
    depth = 32  # 假设体数据的深度
    input_tensor_3d = torch.randn(1, 16, depth, 64, 64)
    print(f"Input shape: {input_tensor_3d.shape}")

    cpca_block_3d = CPCABlock3D(in_channels=16, out_channels=16, channelAttention_reduce=4)
